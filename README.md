...
2. Clone this repository into the ~/.config-zsh directory.

3. Run `sh install.sh` to install this zsh configuration.

4. Run `sh uninstall.sh` to uninstall this zsh configuration.
